...
#pragma comment(lib,"Bullet/lib86/BulletDynamics_debug.lib")
#pragma comment(lib,"Bullet/lib86/LinearMath_debug.lib")
#endif // _DEBUG

#ifdef _RELEASE
#pragma comment (lib,"Bullet/libx86/BulletCollision.lib")
#pragma comment(lib,"Bullet/lib86/BulletDynamics.lib")
#pragma comment(lib,"Bullet/lib86/LinearMath.lib")
#endif // _RELEASE
...
bool ModulePhysics3D::Start()
{
	...
	b2Vec3 g = {0, -10, 0};
	world->setGravity(b2Vec3(GRAVITY));
